...
Kiekvienam mėginiui buvo apskaičiuota vidutinė koreliacija su kitais mėginiais.Tuomet atrinkti mėginiai, kurių vidutinė koreliacija daugiau negu trimis standartiniais nuokrypiais mažesnė už vidutinę. Iš viso atliktos trys šio metodo iteracijos kiekvieną kartą pašalinant atrastus "išskirčių" mėginius.
...
Po antrosios iteracijos gautos išskirtys: 144_CENTRAL_T0, 175_CENTRAL_T0, 18_CENTRAL_T0, 18_CENTRAL_T18, 266_CENTRAL_T18.
Po trečiosios iteracijos gautos išskirtys: 126_CENTRAL_T0, 175_CENTRAL_T18, 233_CENTRAL_T18, 245_CENTRAL_T18, 295_CENTRAL_T0.
...
```{r clusterization 4groups, echo=FALSE, warning=FALSE}
...
Dėl įdomumo medis buvo suskirstytas negu pradinis variantas - 4. Toks suskirstymas atrodo blogas, susidaro proporcingai per didelė viena grupė. Geriausias variantas: 6 grupės.
...
Medis, padalintas į šešias dalis turi smulkią oranžinę grupę. Jai priklauso mėginiai: 175_CENTRAL_T0, 175_CENTRAL_T18, 182_CENTRAL_T0, 182_CENTRAL_T18, 309_CENTRAL_T0, 309_CENTRAL_T18. Trys iš jų sutampa su praeitu išskirčių sąrašu: 175_CENTRAL_T0, 175_CENTRAL_T18, 182_CENTRAL_T0. Klasterizavimo procesas pakartotas pašalinus oranžinės grupės mėginius.

```{r clusterization wo outliers, echo=FALSE, warning=FALSE}
...
Pagal spalvų susiskirstymą gauname iš esmės tas pačias grupes, tik sukeistas vietomis ir su pasikeitusia dendrogramos struktūra. Buvo palygintas mėginių suskirstymas grupėms pašalinus oranžinės grupės mėginius ir juos palikus. Sutampa 86 mėginių paskirstymas grupėms, o 148 mėginių - nesutampa. Tačiau nėra stipraus argumento pašalinti oranžinę grupę, todėl pasiliekama prie šešių grupių dendogramos nešalinant mėginių. Tuomet atlikta mėginių klinikinių charakteristikų analizė pagal iš klasterizavimo gautas grupes.
...
Pasiskirstymas grupėse tarp dietų labai panašus, ryškesni skirtumai matomi ketvirtoje, trečioje grupėje. Ketvirtoje grupėje daugiau besimaitinusių žemo angliavandenių kiekio dieta, o trečioje - žemo riebalų kiekio dieta.
...
Pagal fizinio aktyvumo buvimą/nebuvimą vienodai pasiskirsčiusios pirma ir antra grupės. Nedideli skirtumai pastebimi ketvirtoje ir šeštoje grupėse. Trečioje grupėje daugiau asmenų, kurie užsiėmė fiziniu aktyvumu. Penktoje grupėje vien tik asmenys, kurie nebuvo fiziškai aktyvūs.
...
Penktoje ir šeštoje grupėje amžiaus intervalai siauriausi, penktoje grupėje apie 50-56 metai, ketvirtoje grupėje: 40 - 49 metai. Kitose grupėse amžiaus intervalai platūs: nuo 40-60 metų. Stipriausias grupių pasiskirstymas pastebimas pagal lytį, nestiprią įtaką daro dieta, fizinis aktyvumas, amžius, tačiau daugiausiai informacijos nusako DNR metilinimo pokyčiai, kurių įverčiai apsprendžia susiskirstymą į grupes.
...
Pirmame heatmap'e sunku įžvelgti grupes.