...
```{r linear_model_1, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Volcano grafikas: metilinimo pokytis per metus (x ašis) ir jo statistinis patikimumas (y ašis). Spalvoti taškai — reikšmingi citozinai (p-adj < 0,05)."}
...
```{r manhattan, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Manhattan grafikas: kiekvienai CpG pozicijai pavaizduota -log10(p-adj) vertė pagal genominę poziciją. Raudona linija — reikšmingumo slenkstis (p = 0,05)."}
