...
```{r linear_model_2, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Su amžiumi susijusių CpG pasiskirstymas pagal genominį kontekstą ir metilinimo kryptį."}
...
```{r top10CpG_1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, fig.height=3, fig.cap="Reikšmingiausių citozinų modifikacijos įverčių pasiskirstymas pagal amžių pavaizduojant tiesinės regresijos liniją."}
# 2. Patikimiausių skirtumų profiliai.
...
```{r p_histogram, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Tiesinės regresijos modelio p verčių pasiskirstymas."}
# 3. P-verčių histograma.
...
```{r horvath_1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=7, fig.cap="Šiame grafike pavaizduoti epigenetinio amžiaus įverčiai (papildomai įtraukus CpG, kurių nebuvo duomenyse) lyginant su realiu tiriamųjų amžiumi (pavaizduoti visi mėginiai)."}
...
Beveik visais atvejais epigenetinis amžius yra aukštesnis už chronologinį išskyrus kelis pavienius atvejus. Chronologinio ir epigenetinio amžiaus amplitudės kai kuriais atvejais siekia ir 10 metų, tačiau vidutinis skirtumas yra 6.06 +/- 0.29 metai. Tikėtina, kad citozinus, naudojamus amžiaus skaičiavimui, veikia ne tik amžėjimo procesai, bet ir gyvenimo būdas prieš intervenciją bei pati intervencija, todėl ir atsiranda skirtumai tarp epigenetinio ir realaus amžiaus.

```{r horvath_2, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=7, fig.cap="Šiame grafike pavaizduoti epigenetinio amžiaus įverčiai (naudojant tik CpG, kurie buvo duomenyse) lyginant su realiu tiriamųjų amžiumi (pavaizduoti visi mėginiai)."}
...
```{r analize, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=7, fig.caption="Epigenetinio amžiaus skirtumai tiriamiesiems tyrimo pradžioje ir pabaigoje"}
# Apžvalginė analizė
...
```{r amzius, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, fig.height=7, fig.caption="Histogramos, kuriose vaizduojamas epigenetiškai atjaunėjusių tiriamųjų dieta, fizinio aktyvumo (ne)buvimas ir lytis"}
